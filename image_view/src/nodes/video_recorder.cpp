...
int main(int argc, char** argv)
{
    ...
    node->get_parameter_or_set("filename", filename, std::string("output.avi"));
    node->get_parameter_or_set("image", topic, std::string("/image"));
    node->get_parameter_or_set("fps", fps, 15);
    node->get_parameter_or_set("codec", codec, std::string("MJPG"));
